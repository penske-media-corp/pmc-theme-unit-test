 ...
 *
 * Unit test for class Terms_Importer
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Terms_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Terms_Importer::get_instance()
	 */
	public function test_get_instance() {

		$terms_importer = PMC\Theme_Unit_Test\Terms_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Terms_Importer', $terms_importer );
	}

	/**
	 * @covers Terms_Importer::get_instance()->save_taxonomy_terms
	 */
	...
	/**
	 * @covers Terms_Importer::get_instance()->instant_terms_import
	 */
