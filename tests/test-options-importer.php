 ...
 *
 * Unit test for class Options_Importer
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Options_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Options_Importer::get_instance()
	 */
	public function test_get_instance() {

		$options_importer = PMC\Theme_Unit_Test\Options_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Options_Importer', $options_importer );
	}

	/**
	 * @covers Options_Importer::get_instance()->instant_options_import()
	 * @group test_options
	 */
