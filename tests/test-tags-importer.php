 ...
 *
 * Unit test for class Tags_Importer
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Tags_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Tags_Importer::get_instance()
	 */
	public function test_get_instance() {

		$tags_importer = PMC\Theme_Unit_Test\Tags_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Tags_Importer', $tags_importer );
	}

	/**
	 * @covers Tags_Importer::get_instance()->save_tag
	 */
	...
	/**
	 * @covers Tags_Importer::get_instance()->instant_tags_import
	 */
