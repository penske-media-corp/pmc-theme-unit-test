 ...
 * @group test_menu
 *
 * Unit test for class Menus
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Menus extends WP_UnitTestCase {
	...
	/**
	 * @covers PMC\Theme_Unit_Test\Importer\Menus::get_instance()
	 */
	public function test_get_instance() {

		$menus_importer = PMC\Theme_Unit_Test\Importer\Menus::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Importer\Menus', $menus_importer );
	}

	/**
	 * @covers PMC\Theme_Unit_Test\Importer\Menus::get_instance()->save_menu()
	 * @group test_menu
	 */
	...
	/**
	 * @covers PMC\Theme_Unit_Test\Importer\Menus::get_instance()->instant_menus_import()
	 * @group test_menu
	 */
