 ...
 *
 * Unit test for class Users_Importer
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Users_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Users_Importer::get_instance()
	 */
	public function test_get_instance() {

		$users_importer = PMC\Theme_Unit_Test\Users_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Users_Importer', $users_importer );
	}

	/**
	 * @covers Users_Importer::get_instance()->save_user
	 */
	...
	/**
	 * @covers Users_Importer::get_instance()->instant_users_import
	 */
