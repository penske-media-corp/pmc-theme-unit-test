 ...
 *
 * Unit test for class Attachments_Importer
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Attachments_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Attachments_Importer::get_instance()
	 */
	public function test_get_instance() {

		$attachments_importer = PMC\Theme_Unit_Test\Attachments_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Attachments_Importer', $attachments_importer );
	}

	/**
	 * @covers Attachments_Importer::get_instance()->save_featured_image()
	 */
	...
	/**
	 * @covers Attachments_Importer::get_instance()->instant_attachments_import()
	 */
