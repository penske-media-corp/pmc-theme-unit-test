 ...
 *
 * Unit test for class Posts_Importer
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Posts_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Posts_Importer::get_instance()
	 */
	public function test_get_instance() {

		$posts_importer = PMC\Theme_Unit_Test\Posts_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Posts_Importer', $posts_importer );
	}

	/**
	 * @covers Posts_Importer::get_instance()->save_post()
	 * @group test_posts
	 */
	...
	/**
	 * @covers Posts_Importer::get_instance()->instant_posts_import()
	 * @group test_posts
	 */
