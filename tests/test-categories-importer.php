 ...
 *
 * Unit test for class Categories_Importer
 *
 * Author Archana Mandhare <amandhare@pmc.com>
 *
 */
class Test_Categories_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Categories_Importer::get_instance()
	 */
	public function test_get_instance() {

		$categories_importer = PMC\Theme_Unit_Test\Categories_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Categories_Importer', $categories_importer );
	}

	/**
	 * @covers Categories_Importer::get_instance()->save_category
	 */
	...
	/**
	 * @covers Categories_Importer::get_instance()->instant_categories_import
	 */
