 ...
 *
 */
class Test_Comments_Importer extends WP_UnitTestCase {
	...
	/**
	 * @covers Comments_Importer::get_instance()
	 */
	public function test_get_instance() {

		$comments_importer = PMC\Theme_Unit_Test\Comments_Importer::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\Comments_Importer', $comments_importer );
	}

	/**
	 * @covers Comments_Importer::get_instance()->save_comment()
	 */
	...
	/**
	 * @covers Comments_Importer::get_instance()->instant_comments_import()
	 */
	...
	/**
	 * @covers Comments_Importer::get_instance()->call_rest_api_route()
	 */
