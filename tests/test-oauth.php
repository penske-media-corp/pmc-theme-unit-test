...
class Test_REST_API_oAuth extends WP_UnitTestCase {
	...
	/**
	 * @covers PMC\Theme_Unit_Test\REST_API\O_Auth::get_instance()
	 */
	public function test_get_instance() {

		$rest_api_oauth = PMC\Theme_Unit_Test\REST_API\O_Auth::get_instance();
		$this->assertInstanceOf( 'PMC\Theme_Unit_Test\REST_API\O_Auth', $rest_api_oauth );
	}

	/**
	 * @covers PMC\Theme_Unit_Test\REST_API\O_Auth::get_instance()->access_endpoint()
	 */
	...
	/**
	 * @covers PMC\Theme_Unit_Test\REST_API\O_Auth::get_instance()->is_valid_token()
	 */
